...
#include "../../../include/BattleWidget.h"
...
void BattleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->levelTransitionFinished(); break;
        case 2: _t->pauseRequested(); break;
        case 3: _t->advanceFrame(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (BattleWidget::*)()>(_a, &BattleWidget::battleFinished, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (BattleWidget::*)()>(_a, &BattleWidget::levelTransitionFinished, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (BattleWidget::*)()>(_a, &BattleWidget::pauseRequested, 2))
            return;
    }
}
...
// SIGNAL 0
void BattleWidget::battleFinished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void BattleWidget::levelTransitionFinished()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void BattleWidget::pauseRequested()
{
