...
template <> constexpr inline auto GamePage::qt_create_metaobjectdata<qt_meta_tag_ZN8GamePageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onBattleFinished'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onLevelTransitionFinished'
...
void GamePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->chronicleRequested((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 2: _t->pauseRequested(); break;
        case 3: _t->onBattleFinished(); break;
        case 4: _t->onLevelTransitionFinished(); break;
        case 5: _t->updateStats(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GamePage::*)()>(_a, &GamePage::battleFinished, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GamePage::*)(int , bool )>(_a, &GamePage::chronicleRequested, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (GamePage::*)()>(_a, &GamePage::pauseRequested, 2))
            return;
    }
}
...
// SIGNAL 0
void GamePage::battleFinished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void GamePage::chronicleRequested(int _t1, bool _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1, _t2);
}

// SIGNAL 2
void GamePage::pauseRequested()
{
